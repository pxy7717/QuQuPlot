...
namespace QuquPlot.Utils
{
    ...
    {
        public static readonly string[] ColorPalette = new string[]
        {
        ...
        public static ScottPlot.Color ColorFromHex(string hex, double alpha = 1.0)
        {
            hex = hex.Replace("#", "");
        ...
        /// <returns>ScottPlot.Color对象</returns>
        public static ScottPlot.Color ToScottPlotColor(System.Windows.Media.Color wpfColor, double opacity = 1.0)
        {
